...
Interleaved dataloader samples in PCAP files.
...
def __find_bandwidth(incl_len):
    ...
    # have dataloader data is 60. By adding
...
def __find_nsamples_max(pcap_filesize, nsub):
    ...
    # dataloader is nsub*4 bytes long
    #
...
def read_pcap(pcap_filepath, bandwidth=0, nsamples_max=0):
    ...
    while ptr < pcap_filesize:
        ...
        # nsub*4 bytes: dataloader Data             @ 18 - 18 + nsub*4
    ...
    # Convert dataloader bytes to numpy array
    ...
    # Convert dataloader into complex numbers
